...
SWEP.ViewModel 			= "models/pistol_b/v_pistol_b.mdl" 									-- The viewModel, the model you se when you are holding it.
SWEP.WorldModel 		= "models/pistol_b/w_pistol_b.mdl"   									-- The worlmodel, The model yu when it's down on the ground.
SWEP.HoldType 			= "revolver"                            		-- How the swep is hold Pistol smg greanade melee.
SWEP.PrintName 			= "Pistol (Red)"                         			-- your sweps name.
...
SWEP.Primary.Sound 				= "pistol_b/pistol_b.wav"   
...
function SWEP:Deploy()
   ...
   self.Weapon:EmitSound "pistol_b/draw.wav"
   return true
end
--------------------------------------------------------------------------------|
function SWEP:Holster()
	self.Weapon:EmitSound "pistol_b/holster.wav"
   return true
end
--------------------------------------------------------------------------------|
function SWEP:Reload()
	...
	if ( self.Weapon:Clip1() < self.Primary.ClipSize && self.Owner:GetAmmoCount( self.Primary.Ammo ) > 0 ) then
		...
		self.Weapon:EmitSound("pistol_b/reload.wav")
end
end
--------------------------------------------------------------------------------|
local Time = CurTime()
