...
SWEP.PrintName 			= "Sabre (Blue)"  						-- The Main Name Of The SWEP
SWEP.ViewModel 			= "models/sabre/v_sabre_a.mdl" 						-- What Weapon The First Person View Sees
...
function SWEP:SecondaryAttack()
	self.Weapon:EmitSound("pomf.mp3", 100, math.random(50, 150))
end
----------------------------------------------------------------------------------------------------------------|