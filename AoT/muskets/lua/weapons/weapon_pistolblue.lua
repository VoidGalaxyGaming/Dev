...
SWEP.ViewModel 			= "models/pistol_a/v_pistol_a.mdl" 									-- The viewModel, the model you se when you are holding it.
SWEP.WorldModel 		= "models/pistol_a/w_pistol_a.mdl"   									-- The worlmodel, The model yu when it's down on the ground.
SWEP.HoldType 			= "revolver"                            		-- How the swep is hold Pistol smg greanade melee.
SWEP.PrintName 			= "Pistol (Blue)"                         			-- your sweps name.
...
SWEP.Primary.Sound 				= "pistol_a/pistol_a.wav"   
...
function SWEP:Deploy()
   ...
   self.Weapon:EmitSound "pistol_a/draw.wav"
   return true
end
--------------------------------------------------------------------------------|
function SWEP:Holster()
	self.Weapon:EmitSound "pistol_a/holster.wav"
   return true
end
--------------------------------------------------------------------------------|
function SWEP:Reload()
	...
	if ( self.Weapon:Clip1() < self.Primary.ClipSize && self.Owner:GetAmmoCount( self.Primary.Ammo ) > 0 ) then
		...
		self.Weapon:EmitSound("pistol_a/reload.wav")
end
end
--------------------------------------------------------------------------------|
local Time = CurTime()
...
function SWEP:Reload()
	...
	timer.Simple(0		,function() self.Weapon:EmitSound(""		 ) end)
	timer.Simple(0		,function() self.Weapon:EmitSound(""	  	 ) end)
	timer.Simple(0		,function() self.Weapon:EmitSound(""		 ) end)
	timer.Simple(0		,function() self.Weapon:EmitSound(""	 	 ) end)
	timer.Simple(0		,function() self.Weapon:EmitSound(""		 ) end)
